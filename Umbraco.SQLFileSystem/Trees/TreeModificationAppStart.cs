...
namespace Umbraco.SQLFileSystem.App_Code
{
    ...
    public class PreviewHandler : ApplicationEventHandler
    {
        ...
        void TreeControllerBase_MenuRendering(TreeControllerBase sender, MenuRenderingEventArgs e)
        {
            ...
            {
                //e.Menu.Items.Add(new ContextMenuSeperator());
                e.Menu.Items.Add(new MenuItem("publish", "Publish") {
                    Icon = "globe",
                    SeperatorBefore = true
                });
                e.Menu.Items.Add(new MenuItem("publish-history", "View history") {
                    Icon = "time"
                });
                e.Menu.Items.Add(new MenuItem("publish-purge", "Purge hisory") {
                 Icon  = "delete"
                });
            }
        }
